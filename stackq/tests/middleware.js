...
var messagePicker = function(m) {
  return m['message'];
};
contract.onPass(function(i) {
  console.log('passed', i);
});
contract.oncePass(function(i) {
  console.log('once passed', i);
});
contract.onReject(function(i) {
  console.log('failed', i);
});
contract.onceReject(function(i) {
  console.log('failed once', i);
});
contract.interogate({
  'message': 'alex',
  'data': [13, 32]
